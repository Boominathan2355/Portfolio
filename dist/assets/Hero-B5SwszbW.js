import{c as C,r as p,j as d,m as D}from"./index-CXRe4Z8v.js";import{S as H}from"./SocialIcons-irSAjpop.js";import{I as R}from"./ImageWithFallback-D1_I4zyb.js";import{m as I}from"./proxy-DttJyzt6.js";import"./github-YAteU9eG.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const q=C("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]);let T={data:""},U=e=>typeof window=="object"?((e?e.querySelector("#_goober"):window._goober)||Object.assign((e||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:e||T,B=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,W=/\/\*[^]*?\*\/|  +/g,z=/\n+/g,h=(e,t)=>{let r="",o="",i="";for(let s in e){let a=e[s];s[0]=="@"?s[1]=="i"?r=s+" "+a+";":o+=s[1]=="f"?h(a,s):s+"{"+h(a,s[1]=="k"?"":t)+"}":typeof a=="object"?o+=h(a,t?t.replace(/([^,])+/g,n=>s.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,l=>/&/.test(l)?l.replace(/&/g,n):n?n+" "+l:l)):s):a!=null&&(s=/^--/.test(s)?s:s.replace(/[A-Z]/g,"-$&").toLowerCase(),i+=h.p?h.p(s,a):s+":"+a+";")}return r+(t&&i?t+"{"+i+"}":i)+o},f={},P=e=>{if(typeof e=="object"){let t="";for(let r in e)t+=r+P(e[r]);return t}return e},Z=(e,t,r,o,i)=>{let s=P(e),a=f[s]||(f[s]=(l=>{let m=0,u=11;for(;m<l.length;)u=101*u+l.charCodeAt(m++)>>>0;return"go"+u})(s));if(!f[a]){let l=s!==e?e:(m=>{let u,x,b=[{}];for(;u=B.exec(m.replace(W,""));)u[4]?b.shift():u[3]?(x=u[3].replace(z," ").trim(),b.unshift(b[0][x]=b[0][x]||{})):b[0][u[1]]=u[2].replace(z," ").trim();return b[0]})(e);f[a]=h(i?{["@keyframes "+a]:l}:l,r?"":"."+a)}let n=r&&f.g?f.g:null;return r&&(f.g=f[a]),((l,m,u,x)=>{x?m.data=m.data.replace(x,l):m.data.indexOf(l)===-1&&(m.data=u?l+m.data:m.data+l)})(f[a],t,o,n),a},Q=(e,t,r)=>e.reduce((o,i,s)=>{let a=t[s];if(a&&a.call){let n=a(r),l=n&&n.props&&n.props.className||/^go/.test(n)&&n;a=l?"."+l:n&&typeof n=="object"?n.props?"":h(n,""):n===!1?"":n}return o+i+(a??"")},"");function j(e){let t=this||{},r=e.call?e(t.p):e;return Z(r.unshift?r.raw?Q(r,[].slice.call(arguments,1),t.p):r.reduce((o,i)=>Object.assign(o,i&&i.call?i(t.p):i),{}):r,U(t.target),t.g,t.o,t.k)}let S,N,$;j.bind({g:1});let g=j.bind({k:1});function V(e,t,r,o){h.p=t,S=e,N=r,$=o}function y(e,t){let r=this||{};return function(){let o=arguments;function i(s,a){let n=Object.assign({},s),l=n.className||i.className;r.p=Object.assign({theme:N&&N()},n),r.o=/ *go\d+/.test(l),n.className=j.apply(r,o)+(l?" "+l:"");let m=e;return e[0]&&(m=n.as||e,delete n.as),$&&m[0]&&$(n),S(m,n)}return i}}var Y=e=>typeof e=="function",E=(e,t)=>Y(e)?e(t):e,G=(()=>{let e=0;return()=>(++e).toString()})(),J=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let t=matchMedia("(prefers-reduced-motion: reduce)");e=!t||t.matches}return e}})(),K=20,L="default",O=(e,t)=>{let{toastLimit:r}=e.settings;switch(t.type){case 0:return{...e,toasts:[t.toast,...e.toasts].slice(0,r)};case 1:return{...e,toasts:e.toasts.map(a=>a.id===t.toast.id?{...a,...t.toast}:a)};case 2:let{toast:o}=t;return O(e,{type:e.toasts.find(a=>a.id===o.id)?1:0,toast:o});case 3:let{toastId:i}=t;return{...e,toasts:e.toasts.map(a=>a.id===i||i===void 0?{...a,dismissed:!0,visible:!1}:a)};case 4:return t.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(a=>a.id!==t.toastId)};case 5:return{...e,pausedAt:t.time};case 6:let s=t.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(a=>({...a,pauseDuration:a.pauseDuration+s}))}}},X=[],ee={toasts:[],pausedAt:void 0,settings:{toastLimit:K}},v={},F=(e,t=L)=>{v[t]=O(v[t]||ee,e),X.forEach(([r,o])=>{r===t&&o(v[t])})},_=e=>Object.keys(v).forEach(t=>F(e,t)),te=e=>Object.keys(v).find(t=>v[t].toasts.some(r=>r.id===e)),A=(e=L)=>t=>{F(t,e)},re=(e,t="blank",r)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...r,id:(r==null?void 0:r.id)||G()}),w=e=>(t,r)=>{let o=re(t,e,r);return A(o.toasterId||te(o.id))({type:2,toast:o}),o.id},c=(e,t)=>w("blank")(e,t);c.error=w("error");c.success=w("success");c.loading=w("loading");c.custom=w("custom");c.dismiss=(e,t)=>{let r={type:3,toastId:e};t?A(t)(r):_(r)};c.dismissAll=e=>c.dismiss(void 0,e);c.remove=(e,t)=>{let r={type:4,toastId:e};t?A(t)(r):_(r)};c.removeAll=e=>c.remove(void 0,e);c.promise=(e,t,r)=>{let o=c.loading(t.loading,{...r,...r==null?void 0:r.loading});return typeof e=="function"&&(e=e()),e.then(i=>{let s=t.success?E(t.success,i):void 0;return s?c.success(s,{id:o,...r,...r==null?void 0:r.success}):c.dismiss(o),i}).catch(i=>{let s=t.error?E(t.error,i):void 0;s?c.error(s,{id:o,...r,...r==null?void 0:r.error}):c.dismiss(o)}),e};var ae=g`
from {
